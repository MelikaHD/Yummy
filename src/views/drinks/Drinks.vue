<template>
  <div class="breakfast-container">
    <h1 class="food-part-title">Drinks</h1>
...
const breakfastFilter = ref([
  { name: "Mocktails", isSelected: true },
  { name: "Teas & Coffees", isSelected: false },
...
onMounted(() => {
  selectedFoodsByCategory.value = foods.value.filter((food) => food.category === "Drink");
